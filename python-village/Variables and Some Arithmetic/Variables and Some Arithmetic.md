<h1> Variables and Some Arithmetic </h1>
<p> A variable is just a name that refers to a value; 
you can think of a variable as a box that stores a piece of data. </p>
